...
public abstract class AbstractRabbitMQConnector implements Serializable {
    ...
    protected final String checkpointDir = "cfs:///stale_state_handling_checkpoint";
    protected final String master;

    public AbstractRabbitMQConnector(String[] args) {
        this(Args.parseMaster(args));
    }
    ...
    protected AbstractRabbitMQConnector(String master){
        this.master = master;
        keySpaceName = "tester";
        primaryTableName = "streaming_demo";
    }
