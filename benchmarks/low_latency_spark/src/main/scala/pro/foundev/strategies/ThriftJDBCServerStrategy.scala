...
class ThriftJDBCServerStrategy(master: String) extends BenchmarkStrategy(master){
  override protected def getStrategyName: String = {"Thrift JDBC Server Strategy"}
